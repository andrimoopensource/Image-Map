...
;(function ($, window, document, undefined) {
    ...
    */
    ...
    EditorWindow.prototype.events = function() {
        ...
        // $(document).off('click', '.sq-window-close');
        // $(document).on('click', '.sq-window-close', function(e) {
        //     self.hide();
        // });

        // Move the window by dragging its header
        // $(document).off('mousedown.' + self.id, '.sq-window-header');
        // $(document).on('mousedown.' + self.id, '.sq-window-header', function(e) {
        ...
        $(document).off('mousedown.' + self.id, '.sq-element-thumb');
        $(document).on('mousedown.' + self.id, '.sq-element-thumb', function(e) {
        ...
        $(document).off('mousemove.elementFromWindow.' + self.id);
        $(document).on('mousemove.elementFromWindow.' + self.id, function(e) {
