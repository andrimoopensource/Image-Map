...
;(function ($, window, document, undefined) {
    ...
    WCPEditor.prototype.events = function () {
        ...
        $(document).on('click', '#wcp-editor-button-create-new-instance', function(e) {
            ...
            $.wcpEditorEventCreatedNewInstance(model.name);
            self.closeModal();
        });
    ...
    WCPEditor.prototype.presentCreateNewModal = function() {
        ...
        $('#wcp-editor-modal input').get(0).focus();
    };
    ...
    //     }
    // };
    // WCPEditorForm.prototype.getFormHTMLWithTabs = function() {
    //     var html = '';
    //     var tabsHTML = '';
    ...
    //     return html;
    // }
    // WCPEditorForm.prototype.getFormHTMLWithoutTabs = function() {
    //     var html = '<div class="wcp-editor-form-wrap">';
    ...
    //             html += '<div class="wcp-editor-form-control" id="wcp-editor-form-control-'+ control.name +'" '+ tooltipAttributes +'>';

    //             if (!this.controls[control.name].customLabel) {
    //                 html += '   <label>'+ control.title +'</label>';
    //             }
    ...
    //     return model;
    // }
    // WCPEditorForm.prototype.setControlValue = function(controlName, v, force) {
    ...
    // deprecated
    $.wcpEditorSetControlValue = function(formName, controlName, v, force) {
        wcpForms[formName].setControlValue(controlName, v, force);
    }
